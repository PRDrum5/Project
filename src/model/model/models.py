...
class Mfcc_Shape_Gen_12_Big(BaseModel):
    def __init__(self, z_dim, shapes_dim):
        super().__init__()

        in_dim = z_dim + 1

        self.conv1 = nn.Conv2d(in_dim, 256, kernel_size=(3,3), padding=(0,6))
        self.relu1 = nn.ReLU()

        self.conv2 = nn.Conv2d(256, 128, kernel_size=(3,3))
        self.relu2 = nn.ReLU()

        self.conv3 = nn.Conv2d(128, 128, kernel_size=(3,3))
        self.relu3 = nn.ReLU()

        self.conv4 = nn.Conv2d(128, 64, kernel_size=(3,3))
        self.relu4 = nn.ReLU()

        self.conv5 = nn.Conv2d(64, 4, kernel_size=(4,5))
        self.sig5 = nn.Sigmoid()
