...
class Mfcc_Shape_Critic(BaseModel):
    def __init__(self, shapes_dim):
        ...
        self.conv9 = nn.Conv1d(256, 1, kernel_size=4)
        self.tanh9 = nn.Tanh()
...
class Shape_Critic_2(BaseModel):
    def __init__(self, shapes_dim):
        ...
        self.conv6 = nn.Conv1d(128, 64, kernel_size=5)
        self.lrelu6 = nn.LeakyReLU(0.2)
...
class Shape_Critic_3(BaseModel):
    def __init__(self, shapes_dim):
        super().__init__()
...
class Lrw_Shape_Classifier(BaseModel):
    def __init__(self):
        ...
        self.conv6 = nn.Conv1d(512, 512, kernel_size=3)
        self.relu6 = nn.ReLU()
        self.drop6 = nn.Dropout(0.1)

        self.lin7 = nn.Linear(3072, 500)
